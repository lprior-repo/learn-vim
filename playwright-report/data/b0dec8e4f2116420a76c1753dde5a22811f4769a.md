...
- Location: /home/family/src/vim/tests/navigation.spec.ts:60:3

# Error details

```
Error: expect.not.toBeVisible: Error: strict mode violation: locator('.animate-spin') resolved to 2 elements:
    1) <div class="↵            animate-spin rounded-full↵            border-t-blue-400 border-r-blue-400↵            border-b-transparent border-l-transparent↵            h-16 w-16 border-4↵          "></div> aka locator('.animate-spin').first()
    2) <div class="↵            animate-spin rounded-full↵            border-t-blue-400 border-r-blue-400↵            border-b-transparent border-l-transparent↵            h-16 w-16 border-4↵          "></div> aka locator('div:nth-child(2) > .relative > .animate-spin')

Call log:
  - expect.not.toBeVisible with timeout 5000ms
  - waiting for locator('.animate-spin')
    - locator resolved to <div class="↵            animate-spin rounded-full↵            border-t-blue-400 border-r-blue-400↵            border-b-transparent border-l-transparent↵            h-16 w-16 border-4↵          "></div>
    - unexpected value "visible"

    at ensurePageLoaded (/home/family/src/vim/tests/navigation.spec.ts:22:53)
    at /home/family/src/vim/tests/navigation.spec.ts:69:5
```
