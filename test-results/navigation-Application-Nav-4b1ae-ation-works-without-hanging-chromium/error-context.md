...
- Name: Application Navigation - ATDD >> Given user is on command detail page - When navigating back home - Then navigation works without hanging
- Location: /home/family/src/vim/tests/navigation.spec.ts:102:3
...
Call log:
  ...
  - waiting for locator('h1, h2').first()
    ...
    at /home/family/src/vim/tests/navigation.spec.ts:111:7
```
