...
- Name: Application Navigation - ATDD >> Given user sees featured commands - When clicking view all links - Then category pages load properly
- Location: /home/family/src/vim/tests/navigation.spec.ts:64:3
...
Call log:
  ...
  - waiting for locator('h1, h2').first()
    ...
    at /home/family/src/vim/tests/navigation.spec.ts:73:5
```
